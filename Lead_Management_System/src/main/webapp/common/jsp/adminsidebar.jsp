...
<div id="mySidenav" class="sidenav">
	  ...
	  <a href="show-all-comments-by-admin.jsp"class="icon-a"><i class="fa fa-comments-o icons"></i> All Comments</a>
	  <a href="show-all-interview-by-admin.jsp"class="icon-a"><i class="fa fa-calendar icons"></i> All Interviews</a>
	  <a href="show-all-added-by-admin.jsp"class="icon-a"><i class="fa fa-plus icons"></i> All Added</a>
