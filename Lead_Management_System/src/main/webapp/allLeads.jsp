			...
			<div class="p-2">
				<%
					...
					<a class='submit-btn w-100'
						...
						href="/Lead_Management_System/allLeads.jsp?page=<%=currentPage - 1%>">
						&lt; Previous</a>
					<%
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/allLeads.jsp?page=<%=i%>"><%=i%></a>
					<%
					}
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/allLeads.jsp?page=<%=currentPage + 1%>">Next
						&gt;</a>
					<%
					}
					%>
