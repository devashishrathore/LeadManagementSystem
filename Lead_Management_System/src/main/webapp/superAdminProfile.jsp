...
<body>
	...
	<div id="main">
		...
		<div class="main-container pb-1">
			...
			<form action="updateSuperAdminProfile.jsp" method="post"
				class="w-100 d-flex align-items-center justify-content-center mb-5">
				<button type="submit" class="submit-btn w-50">Update
					Profile</button>
			</form>
		</div>
	</div>
