...
List<User> userList = superAdminDao.getAllUserByLimitAndOffset(itemsPerPage, (currentPage - 1) * itemsPerPage,"Admin");
...
<body>
	...
	<div class="mt-3 mb-3 status-card-cantainer">
		...
		<div class="pe-2 ps-2">
			<p class="fs-2 text-white box-heading">All Admin</p>
		</div>	
		<hr class="divide">
				...
				<table class="table table-dark table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><%= u.getMobile() %></td>
							<td>
								<a class = 'submit-btn all-comments-btn btn' style="text-decoration: none;width:100%;" href="/Lead_Management_System/show-admin-comments-by-superadmin.jsp?userid=<%= u.getId()%>">View Comments</a>
							</td>
							<td >
...
<script>
	...
	function myFunction(id) {
		if(confirm("Are you sure want to delete?") == true){
			window.location.href = "/Lead_Management_System/DeleteAdmin?delete="+id ;
		}else{
			alert("Canceled!");
