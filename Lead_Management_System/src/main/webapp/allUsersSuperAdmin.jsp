				...
				<table class="table table-dark table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><%= u.getMobile() %></td>
							<td>
								<a class = 'submit-btn all-comments-btn btn' style="text-decoration: none;width:100%;"  href="/Lead_Management_System/show-user-comment-by-superadmin.jsp?userid=<%= u.getId()%>">View</a>
							</td>
							<td>
...
<!--		Start Pagination -->
	...
	function myFunction(id) {
		if(confirm("Are you sure want to delete?") == true){
			window.location.href = "/Lead_Management_System/DeleteSuperAdminUsers?delete="+id ;
		}else{
			alert("Canceled!");
