...
<body>
	...
	<div id="main">
		...
		<div class="main-container p-2">
			<form action="/Lead_Management_System/search-admin-leads.jsp"
				method="get" class="">
				<div class="row">
		...
		<div class="main-container">
			...
			<div>
				...
				<a class='submit-btn w-100'
					...
					href="/Lead_Management_System/search-admin-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=currentPage - 1%>">
					&lt; Previous</a>
				<%
				}
				%>
				...
				<a class='submit-btn w-100'
					style="padding: 2px 4px; text-decoration: none;"
					href="/Lead_Management_System/search-admin-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=i%>"><%=i%></a>
				<%
				}
				}
				%>
				...
				<a class='submit-btn w-100'
					style="padding: 2px 4px; text-decoration: none;"
					href="/Lead_Management_System/search-admin-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=currentPage + 1%>">Next
					&gt;</a>
				<%
				}
				%>
