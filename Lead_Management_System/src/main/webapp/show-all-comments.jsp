...
<%
	...
	int itemsPerPage = 20;
	List<Comment> listComment = commentDao.getAllCommentByUserIdOffset(userCookie.getId(), itemsPerPage, (currentPage - 1) * itemsPerPage);
...
<body>
	...
	<div id="main">
		...
		<div class="pe-2 ps-2">
			<p class="fs-2 text-white box-heading">All User Comments (Total Results: <%=listComment.size()%>, Page <%=currentPage%>/<%=totalPages %>)</p>
		</div>
		<hr class="divide">
		<div class="main-container">
				...
				<div class="comment-inner-conatiner mt-2">
					<div class="comment-content">
			            ...
			            <div class="btn-container" style="flex-direction: column;text-decoration: none;">
							...
							<a style="text-decoration: none;" class="text-center submit-btn" href="/Lead_Management_System/show-user-lead-comment.jsp?leadid=<%= comment.getLeadid() %>" >-- View --</a>
			...
			<div>
					...
					<a class='submit-btn w-100'
						...
						href="/Lead_Management_System/show-all-comments.jsp?page=<%=currentPage - 1%>">
						&lt; Previous</a>
					<%
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/show-all-comments.jsp?page=<%=i%>"><%=i%></a>
					<%
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/show-all-comments.jsp?page=<%=currentPage + 1%>">Next
						&gt;</a>
					<%
					}
					%>
