...
int totalLeadCountByAdded = leadDao.getUserInterviewLeadsCount(userCookie.getEmail(), companyId, "Added in Batch");int totalLeadCountNewLeads = leadDao.getLeadsCountNewLeadsByCompanyId(companyId);
	...
	<div id="main">
		...
		<div class="pe-2 ps-2">
			...
			<%if(list.size() <= 0) {
				...
				<%=leadCount%>, Page <%= currentPage %>/<%=totalPages%>)</p>
		</div>
		<hr class="divide">
		<div class="main-container">
			<div class="p-2">
			...
			<div>
				...
				<a class='submit-btn w-100'
					...
					href="/Lead_Management_System/search-user-posted-leads.jsp?page=<%=currentPage - 1%>">
					&lt; Previous</a>
				<%
				}
				%>
				...
				if(endPage!=1){
					for (int i = startPage; i <= endPage; i++) {
						...
						<a class='submit-btn w-100'
							style="padding: 2px 4px; text-decoration: none;"
							href="/Lead_Management_System/search-user-posted-leads.jsp?page=<%=i%>"><%=i%></a>
						<%
						}
				}
				%>
				...
				<a class='submit-btn w-100'
					style="padding: 2px 4px; text-decoration: none;"
					href="/Lead_Management_System/search-user-posted-leads.jsp?page=<%=currentPage + 1%>">Next
					&gt;</a>
				<%
				}
				%>
