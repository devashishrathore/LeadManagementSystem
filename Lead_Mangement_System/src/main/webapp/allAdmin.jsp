				...
				<table class="table table-dark table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><%= u.getMobile() %></td>
							<td>
								<a class = 'submit-btn all-comments-btn btn' style="text-decoration: none;width:100%;" href="/Lead_Mangement_System/show-admin-comments-by-superadmin.jsp?userid=<%= u.getId()%>">View Comments</a>
							</td>
							<td >
