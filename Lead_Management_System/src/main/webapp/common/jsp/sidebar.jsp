...
<div id="mySidenav" class="sidenav">
	  ...
	  <a href="show-all-comments.jsp"class="icon-a"><i class="fa fa-comments-o icons"></i> My Comments</a>
	  <a href="show-all-interview.jsp"class="icon-a"><i class="fa fa-calendar icons"></i> My Interviews</a>
	  <a href="show-all-added.jsp"class="icon-a"><i class="fa fa-plus icons"></i> My Added</a>
