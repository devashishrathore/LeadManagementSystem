...
<body>
	...
	<div id="main">
		...
		<div class="main-container">
			<form action="/Lead_Management_System/search-user-leads.jsp"
				method="get">
				<div class="row">
		...
		<div class="main-container">
			...
			<div>
				...
				<a class='submit-btn w-100'
					...
					href="/Lead_Management_System/search-user-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=currentPage - 1%>">
					&lt; Previous</a>
				<%
				}
				%>
				...
				if(endPage!=1){
					for (int i = startPage; i <= endPage; i++) {
						...
						<a class='submit-btn w-100'
							style="padding: 2px 4px; text-decoration: none;"
							href="/Lead_Management_System/search-user-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=i%>"><%=i%></a>
						<%
						}
				}
				%>
				...
				<a class='submit-btn w-100'
					style="padding: 2px 4px; text-decoration: none;"
					href="/Lead_Management_System/search-user-leads.jsp?searchby=<%=searchBy%>&search=<%=search %>&page=<%=currentPage + 1%>">Next
					&gt;</a>
				<%
				}
				%>
