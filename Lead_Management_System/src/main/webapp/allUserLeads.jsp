...
<body>
	...
	<div id="main">
		...
		<div class="main-container p-2">
			<form action="/Lead_Management_System/search-user-leads.jsp" method="get">
				<div class="row">
		...
		<div class="pe-2 ps-2">
			<p class="fs-2 text-white box-heading"><%if(list.size() <= 0) {
				...
				}%>All Leads (Total Results: <%= totalLeadCount %>, Page <%= currentPage %>/<%=totalPages%>)</p>
		</div>
		<hr class="divide">		
		...
		<%if(list.size()<=0){%>
			...
			<%}else{%>
				...
				<table class="table table-dark table-striped table-hover" id= "table-id">
					...
					<tr>
						...
						<td><%= l.getCreationDate().toLocaleString() %></td>
						<td>
			...
			<div>
					...
					<a class='submit-btn w-100'
						...
						href="/Lead_Management_System/allUserLeads.jsp?page=<%=currentPage - 1%>">
						&lt; Previous</a>
					<%
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/allUserLeads.jsp?page=<%=i%>"><%=i%></a>
					<%
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/allUserLeads.jsp?page=<%=currentPage + 1%>">Next
						&gt;</a>
					<%
					}
					%>
