...
int itemsPerPage = 20;
int totalPages = (int) Math.ceil((double) totalLeadCountBySource / itemsPerPage);
...
<body>
	...
	<div id="main">
		...
		<div class="main-container p-2">
			<form action="/Lead_Management_System/search-user-assigned-leads.jsp" method="get">
				<div class="row">
		...
		<div class="pe-2 ps-2">
			<p class="fs-2 text-white box-heading">All Assigned Leads (Total Results: <%= totalLeadCountBySource %>, Page <%= currentPage %>/<%=totalPages%>)</p>
		</div>
		<hr class="divide">
...
<!--		Start Pagination -->
			<div>
					...
					<a class='submit-btn w-100'
						...
						href="/Lead_Management_System/currentLead.jsp?page=<%=currentPage - 1%>">
						&lt; Previous</a>
					<%
					}
					%>
					...
					if(endPage!=1){
						for (int i = startPage; i <= endPage; i++) {
							...
							<a class='submit-btn w-100'
								style="padding: 2px 4px; text-decoration: none;"
								href="/Lead_Management_System/currentLead.jsp?page=<%=i%>"><%=i%></a>
							<%
							}
					}
					%>
					...
					<a class='submit-btn w-100'
						style="padding: 2px 4px; text-decoration: none;"
						href="/Lead_Management_System/currentLead.jsp?page=<%=currentPage + 1%>">Next
						&gt;</a>
					<%
					}
					%>
