...
<%
	...
	int totalLeadCountByAdded = leadDao.getLeadsCountUsingCompanyIdAndStatus(companyId, "Added in Batch");int userCount = userDao.getUserCount("User", companyId);
					...
					<table class="table table-dark table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><%= u.getMobile() %></td>
								<td>
									<a class = 'submit-btn all-comments-btn btn' style="text-decoration: none;width:100%;" href="/Lead_Management_System/show-user-comments-by-admin.jsp?userid=<%= u.getId()%>">View</a>
								</td>
								<td>
...
/* Delete confirmation alert */
	function myFunction(email) {
		...
		if(confirm("Are you sure want to delete?") == true){
			window.location.href = "/Lead_Management_System/deleteAdminUsers?delete="+email ;
		}else{
			alert("Canceled!");
