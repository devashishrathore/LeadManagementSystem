...
public class SuperAdminDao {
	...
	public static final String TOTAL_LEADS_COUNT_NEW_LEADS = "SELECT COUNT(id) FROM leads WHERE date::date = CURRENT_DATE  ";
	public static final String TOTAL_LEADS = "SELECT COUNT(id) FROM leads ";
	public static final String TOTAL_LEADS_COUNT_OF_USER_USING_ID_AND_STATUS = "SELECT COUNT(id) FROM leads WHERE status=?";
	...
	private static final String SEARCH_LEADS_BY_ID_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE id=? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_EMAIL_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE email ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_ADDRESS_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE address ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_MOBILE_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE mobile ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_STATUS_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE status ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_OWNER_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE owner ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	private static final String SEARCH_LEADS_BY_NAME_OFFSET_AND_LIMIT = "SELECT * FROM leads WHERE name ILIKE ? ORDER BY id DESC LIMIT ? OFFSET ? ";
	...
	public int getLeadsCountUsingStatus(String status) {
		int count = 0;
		try {
